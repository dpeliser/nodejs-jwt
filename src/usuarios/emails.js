...
class EmailRedefinicaoSenha extends Email {
  constructor (usuario, token) {
    ...
    this.text = `Olá! Voce pediu para redefinir sua senha. Use esse token para trocar a sua senha: ${token}`
    this.html = `<h1>Olá!</h1> Olá! Voce pediu para redefinir sua senha. Use esse token para trocar a sua senha: ${token}`
  }
}
